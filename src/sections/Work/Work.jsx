        ...
        <div className="work-container" id="Section_Work">
                <div className="work" >
                    ...
                    <div style={{marginBottom: "2rem", display: "flex", alignItems: "flex-start", gap: "1.5rem"}}>
                        <div style={{minWidth: "70px", height: "70px", backgroundColor: "#f5f5f5", borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, padding: "0.5rem"}}>
