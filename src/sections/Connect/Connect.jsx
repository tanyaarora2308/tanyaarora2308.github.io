...
const Connect = () => {
    return (
        <div style={{textAlign:"center"}} id="Section_Contact">
            <Zoom>
            <span style={{display:"block",textAlign:"center",color: "var(--green)",fontFamily: "'Roboto Mono', monospace",fontSize: "1rem"}}>05. What's Next?</span>
            ...
            <p className="home-btn" style={{marginBottom:"10%"}}><a href="mailto:tanya.arora.connect@gmail.com" style={{fontSize: "13px", fontFamily: "'Roboto Mono', monospace", color: " var(--green)", textDecoration: "none"}} className="ButtonStyle">Say Hello</a></p>
            </Zoom>
        </div>
    )
}
